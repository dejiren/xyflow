...
import React__default, { useMemo, useState, useEffect, useRef, memo, useCallback, createContext, forwardRef, useContext, useLayoutEffect } from 'react';
 ...
 */
var g$1=React__default;function n$1(a,b){return a===b&&(0!==a||1/a===1/b)||a!==a&&b!==b}var p$1="function"===typeof Object.is?Object.is:n$1,q$1=g$1.useSyncExternalStore,r$1=g$1.useRef,t$1=g$1.useEffect,u=g$1.useMemo,v$1=g$1.useDebugValue;
useSyncExternalStoreWithSelector_production_min.useSyncExternalStoreWithSelector=function(a,b,e,l,h){var c=r$1(null);if(null===c.current){var f={hasValue:!1,value:null};c.current=f;}else f=c.current;c=u(function(){function a(a){if(!c){c=!0;d=a;a=l(a);if(void 0!==h&&f.hasValue){var b=f.value;if(h(b,a))return k=b}return k=a}b=k;if(p$1(d,a))return b;var e=l(a);if(void 0!==h&&h(b,e))return b;d=a;return k=e}var c=!1,d,k,m=void 0===e?null:e;return [function(){return a(b())},null===m?void 0:function(){return a(m())}]},[b,e,l,h]);var d=q$1(a,c[0],c[1]);
...
function createAction$1(type, payload) {
  return {
    type: type,
    payload: payload
  };
...
var wrapNode = (function (NodeComponent) {
  var NodeWrapper = function NodeWrapper(_ref) {
    ...
    return (
      /*#__PURE__*/
      // @ts-ignore
      React__default.createElement(DraggableCore_1, {
        onStart: onDragStart,
        onDrag: onDrag,
        onStop: onDragStop,
        scale: scale,
...
var Wrapper = function Wrapper(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(Provider_default, {
    store: store
  }, children);
};
